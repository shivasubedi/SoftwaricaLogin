...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        Students students = new Students("test", "KTM", "others", "15",R.drawable.noimg);
        studentsList = students.getStudentsList();
        if (studentsList.isEmpty()){
            studentsList.add(new Students("Shiva Subedi", "Kathmandu", "Male", "25", R.drawable.maleimg));
            studentsList.add(new Students("subedi shiva", "pokhara", "Female", "24", R.drawable.femaleimg));
