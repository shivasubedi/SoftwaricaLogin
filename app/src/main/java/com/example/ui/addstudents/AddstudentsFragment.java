...
public class AddstudentsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        final View main = inflater.inflate(R.layout.fragment_addstudents, container, false);
        etName = main.findViewById(R.id.etName);
        etAge = main.findViewById(R.id.etAge);
        etAddress = main.findViewById(R.id.etAddress);
        rgGender = main.findViewById(R.id.rgGender);
        rbMale = main.findViewById(R.id.rbMale);
        rbFemale = main.findViewById(R.id.rbFemale);
        rbOthers = main.findViewById(R.id.rbOthers);
        btnSave = main.findViewById(R.id.btnSave);
        recyclerViewhome = main.findViewById(R.id.recyclerView);
                    ...
                    if (!etAge.getText().toString().isEmpty()) {
                        ...
                        if (!etAddress.getText().toString().isEmpty()) {
                            ...
                            try {
                                ...
                                RadioButton radioButton = main.findViewById(selectGender);
